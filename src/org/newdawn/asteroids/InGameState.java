...
/**
 * This state is responsible for rendering the game world and handling the mechanics of
 * game play.
 * 
...
public class InGameState implements GameState, EntityManager {
    ...
    private final float WINDOW_WIDTH = 1920f;
    private final float WINDOW_HEIGHT = 1080f;

    private final ArrayList<Entity> entities = new ArrayList<Entity>();
    private final ArrayList<Entity> addList = new ArrayList<Entity>();
    private final ArrayList<Entity> removeList = new ArrayList<Entity>();

    private final ArrayList<Texture> shipTextures = new ArrayList<Texture>();
