...
/**
 * An abstract implementation of an in game entity. This provides the code for the common
 * functionality between the majority of entities including movement, rotating and
 * collision detection.
 * 
 * Note that even thought the game entites are actually 3D models and the whole game is
 * run in 3D the entities are only allowed to move on a 2D plane giving that classic 2D
 * asteroids look and feel.
 * 
 * @author Drew Murphy, Kevin Glass
 */
public abstract class AbstractEntity implements Entity {
    /** The width of the play area - determined by trying things until it felt right */
    private static final int PLAY_AREA_WIDTH = 75;
